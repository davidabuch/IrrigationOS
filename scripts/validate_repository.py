...
REQUIRED_FILES = (
    ...
    "docs/V1_0_51_ZONE_1_FACTOR_CLOSURE.md",
    "docs/V1_0_52_GENERIC_ZONE_COMMISSIONING.md",
    "docs/adr/ADR-024-generic-zone-commissioning.md",
    "docs/V1_0_53_GENERIC_COMMISSIONING_PERSISTENCE.md",
...
def main() -> int:
    ...
    if manifest.get("version") != "1.0.60":
        raise SystemExit("manifest.json version must be 1.0.60")
